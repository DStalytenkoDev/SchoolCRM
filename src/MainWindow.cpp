...
{
    ui->setupUi(this);
    this->setWindowTitle("SchooliesCave");
...
{
    QMessageBox::information(this, "Help", "Please check out issues on the project's repo: https://github.com/DStalytenkoDev/SchooliesCave/issues");
}
